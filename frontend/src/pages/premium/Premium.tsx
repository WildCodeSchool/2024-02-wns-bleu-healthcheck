...
const Premium = () => {
    ...
    return (
        <div className="premium__wrapper">
            <h1 className="premium__main_title">Pourquoi devenir membre Premium ?</h1>
            <div className="premium__options_container">
              <div className="premium__options_wrapper">
                ...
                <div className="premium__option_square">
                  ...
                  <div className="premium__features">
                    ...
                    <span>&#10003; Historique des requêtes</span>
                    <span><span
                      className="premium__features_green">&#10003;</span> Jusqu'à 100 requêtes enregistrées</span>
                    <span><span
                      className="premium__features_green">&#10003;</span> Fréquence réglable (1-60 minutes)</span>
